...
import { Upload, Play, Pause, Video, RefreshCw } from "lucide-react";
...
export function VideoPlayer({
  ...
  const drawDetections = useCallback(
    (detections: DetectedFace[], displaySize: { width: number; height: number }) => {
            ...
            {videoError && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/80">
                <div className="text-center p-4">
                  ...
                  <p className="text-white/50 text-xs mt-2">Please try uploading a different video file</p>
                </div>
              </div>
            )}
          </div>
